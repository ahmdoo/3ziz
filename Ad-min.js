...
#users .uzr.stl1 {
  ...
  background-image: url("https://e.top4top.io/p_2593u8gzc0.png");
      background-size: cover;
}
...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('محمد')").addClass('stl1');
        $("#users .uzr.stl1 .c-flex.fr").append('<img class="My_star1" src="https://f.top4top.io/p_2593paryo0.gif">');
	
	$("#users .uzr.stl1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary Ahmed" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 0px 50px 50px 0px;padding: 0px;background-color: #EDEDED!important;color:#000;" href="https://fhh0.com/">حيـاكم شات فهاوة</div>');
